...
public class BitmapUtils {
     ...
     * @param imgUrl
     */
    public static void showCircleBitmap(Context ctx, CircleImageView iv, String imgUrl, int placeImg, int errorImg) {
        Glide.with(ctx)
                .load(imgUrl)
                .asBitmap()
    ...
    public static void showBitmap(Context ctx, ImageView iv, String imgUrl, onFinishedLoad finishedLoad,
                                  onFailedLoad failedLoad,int placeImg,int errorImg) {
